...
func (_m *MockAccountRepository) Insert(_a0 context.Context, _a1 auth.UseCaseResult[authdomain.PasswordAuthentication]) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, auth.UseCaseResult[authdomain.PasswordAuthentication]) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockAccountRepository_Insert_Call) Run(run func(_a0 context.Context, _a1 auth.UseCaseResult[authdomain.PasswordAuthentication])) *MockAccountRepository_Insert_Call {
...
func (_c *MockAccountRepository_Insert_Call) RunAndReturn(run func(context.Context, auth.UseCaseResult[authdomain.PasswordAuthentication]) error) *MockAccountRepository_Insert_Call {
	_c.Call.Return(run)
	return _c
}
