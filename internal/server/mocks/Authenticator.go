...
func (_m *Authenticator) Authenticate(_a0 context.Context, _a1 string, _a2 string) (auth.Account, error) {
...
//   - _a1 string
//   - _a2 string
func (_e *Authenticator_Expecter) Authenticate(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Authenticator_Authenticate_Call {
	return &Authenticator_Authenticate_Call{Call: _e.mock.On("Authenticate", _a0, _a1, _a2)}
}

func (_c *Authenticator_Authenticate_Call) Run(run func(_a0 context.Context, _a1 string, _a2 string)) *Authenticator_Authenticate_Call {
...
func (_c *Authenticator_Authenticate_Call) Return(_a0 auth.Account, _a1 error) *Authenticator_Authenticate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Authenticator_Authenticate_Call) RunAndReturn(run func(context.Context, string, string) (auth.Account, error)) *Authenticator_Authenticate_Call {
	_c.Call.Return(run)
	return _c
}
